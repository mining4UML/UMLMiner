...
public enum LogActivity {
    ...
    ADD_RELATIONSHIP("Add class relation", ActionType.ADD, ModelType.RELATIONSHIP),
    ...
    UPDATE_RELATIONSHIP("Update class relation", ActionType.UPDATE, ModelType.RELATIONSHIP),
    ...
    REMOVE_RELATIONSHIP("Remove class relation", ActionType.REMOVE, ModelType.RELATIONSHIP),
