...
public enum LogActivity {
    ...
    ADD_TEMPLATE_PARAMETER(ActionType.ADD, ModelType.TEMPLATE_PARAMETER),
    ...
    UPDATE_TEMPLATE_PARAMETER(ActionType.UPDATE, ModelType.TEMPLATE_PARAMETER),
    ...
    REMOVE_TEMPLATE_PARAMETER(ActionType.REMOVE, ModelType.TEMPLATE_PARAMETER),
